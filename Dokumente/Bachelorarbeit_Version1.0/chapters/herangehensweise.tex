...
modern                                                                                                        & \begin{tabular}[c]{@{}l@{}}wenig Übersicht über das Spielfeld, welche Zahl wo\\ liegen ist nicht gegeben\end{tabular} \\ \hline
...
\begin{tabular}[c]{@{}l@{}}wenig Übersicht kommt dem Such-\\ character allerdings zugute.\end{tabular}          &  \\ \hline
\end{tabular}
\caption{Tabelle: 3D + ThirdPerson\label{fig:3dthird}}
\end{table}
\newpage
...
Gute Übersicht wo welche Zahl liegt     &                                                                                                         \\ \hline
                                        ...
                                        &                                                                                                         \\ \hline
\end{tabular}
\caption{Tabelle: 3D + TopDown\label{fig:3dTop}}
\end{table}
...
\hline
\multicolumn{1}{|c|}{\textbf{Vorteile}} & \multicolumn{1}{c|}{\textbf{Nachteile}}                                                                         \\ \hline
einfache Umsetzung                      & nichts neues                                                                                                    \\ \hline
...
Gute Übersicht wo welche Zahl liegt     &                                                                                                                 \\ \hline
                                        ...
                                        &                                                                                                                 \\ \hline
\end{tabular}
\caption{Tabelle: 2D + TopDown\label{fig:2dTop}}
\end{table}
\subsection{GridSpielfeld}
Weiterhin stand zur Auswahl ob das SnakeSpiel mit einem Grid-Spielfeld oder ohne erstellt werden soll. Mit einem Grid-Spielfeld ist gemeint, dass das Spielfeld in einzelne kleinere Felder aufgeteilt ist auf denen sich die Schlange bewegen kann und pro 'Zug' jeweils ein Feld weiter rückt und dieses komplett ausfüllt.
\newpage
...
\begin{tabular}[c]{@{}l@{}}Objekte können nicht ineinander\\ liegen\end{tabular}            &                                                                                              \\ \hline
                                                                                            ...
                                                                                            &                                                                                              \\ \hline
\end{tabular}
\caption{Tabelle: Snake mit Grid\label{fig:grid}}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}Spieler kann sich in mehr als\\ 4 Richtungen bewegen\end{tabular}            & Aufwändiger in der Umsetzung            \\ \hline
\begin{tabular}[c]{@{}l@{}}Leveldesign kann durch verschiedene\\ Formen unterstützt werden\end{tabular} &                                         \\ \hline
                                                                                                        &                                         \\ \hline
                                                                                                        &                                         \\ \hline
\end{tabular}
\caption{Tabelle: Snake ohne Grid\label{fig:nogrid}}
\end{table}
Entschieden wurde sich für die beiden 3D Varianten ohne Grid, da das Ziel war beide Versionen vergleichen zu können um zu ermitteln, welche Version bei Spielern besser ankommt. Außerdem konnten wir so für beide Versionen die gleichen Grafiken verwenden. So blieb der Fokus auf der unterschiedlichen Perspektive auf das Spielgeschehen. Ebenfalls wurde sich gegen ein Grid, also eine Einteilung in mehrere Felder, auf denen sich die Schlange bewegt, entschieden um eine modernere Steuerung für Snake umzusetzen.
